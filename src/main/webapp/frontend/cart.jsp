...
<div class="cart-container">
    <h1 class="heading-title">Your Cart</h1>
         ...
         <div  style= "padding:16px; background-color:#7ABA78; color:white; margin-bottom:16px">
        Proceeded to order successfully
    </div>
