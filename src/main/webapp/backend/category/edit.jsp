...
<head>
    ...
    <title>Admin Dashboard - Edit ${category.categoryName} </title>
        ...
        <div class="dashboard-content" style="padding: 20px;">
          ...
          <div class="center-container">
            <div class="form-container">
                <h2 class="form-title">Edit Category ${category.categoryName}</h2>

                
                
              <form action="updateCategory" method="POST">
                    <input type="hidden" id="categoryId" name="id" value="${category.id}" readonly>
                 <div class="input-container">
                        <input type="text" class="form-input" placeholder="Category Name" name="categoryName" value="${category.categoryName}">
                        <input type="text" class="form-input" placeholder="Category Slug" name="categorySlug" value="${category.categorySlug}">
                    </div>
                     <label for="status">Status:</label>
                      <input  class="" type="checkbox" id="status" name="status" ${category.status ? 'checked' : ''}>
                    
                    <button type="submit" class="form-submit" style="width:170px">Update Category</button>
